...
public final class ControlCommandCoordinator {
    ...
    public nonisolated func handleSocketWorkerV2(
        ...
        case "simulator.context", "simulator.prepare_screenshot",
             ...
             "simulator.snapshot_ui", "simulator.wait_for_ui",
             "simulator.gesture", "simulator.multi_touch",
             "simulator.tap", "simulator.touch", "simulator.swipe", "simulator.drag",
             "simulator.long_press", "simulator.type_text",
             "simulator.key_press", "simulator.key_sequence",
             "simulator.button", "simulator.gesture_preset", "simulator.batch",
             "simulator.rotate", "simulator.core_animation",
